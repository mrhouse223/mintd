...
/// `s` and `sPrev` are sqrtPriceX96 as BigInt. Returns "BUY" | "SELL" | "HOLD".
function decide(s, sPrev, deadZone = DEAD_ZONE, sellMult = SELL_MULT) {
  ...
  const r = Number((num * 1_000_000n) / (sPrev * sPrev));
